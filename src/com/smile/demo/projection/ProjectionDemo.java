 ...
 *******************************************************************************/
package com.smile.demo.projection;
...
import com.smile.data.NominalAttribute;
...
public abstract class ProjectionDemo extends JPanel implements Runnable, ActionListener {
    ...
    private static String[] datasource = {
        "/data/classification/iris.txt",
        "/data/projection/USArrests.txt",
        "/data/projection/food.txt",
        "/data/classification/pendigits.txt",
        "/data/projection/COMBO17.dat"
    };
