...
import com.smile.data.AttributeDataset;
import com.smile.data.parser.DelimitedTextParser;
...
public abstract class VQDemo extends JPanel implements Runnable, ActionListener, AncestorListener {
    ...
    private static String[] datasource = {
        "/data/clustering/gaussian/one.txt",
        "/data/clustering/gaussian/two.txt",
        "/data/clustering/gaussian/three.txt",
        "/data/clustering/gaussian/five.txt",
        "/data/clustering/gaussian/six.txt",
        "/data/clustering/gaussian/elongate.txt",
        "/data/clustering/nonconvex/cross.txt",
        "/data/clustering/nonconvex/d4.txt",
        "/data/clustering/nonconvex/face.txt",
        "/data/clustering/nonconvex/pie.txt",
        "/data/clustering/nonconvex/ring.txt",
        "/data/clustering/nonconvex/sincos.txt",
        "/data/clustering/chameleon/t4.8k.txt",
        "/data/clustering/chameleon/t5.8k.txt",
        "/data/clustering/chameleon/t7.10k.txt",
        "/data/clustering/chameleon/t8.8k.txt",
        "/data/clustering/neuralgas/Discrete.txt",
        "/data/clustering/neuralgas/Rectangle.txt",
        "/data/clustering/neuralgas/Circle.txt",
        "/data/clustering/neuralgas/Ring.txt",
        "/data/clustering/neuralgas/Complex1.txt",
        "/data/clustering/neuralgas/Complex2.txt",
        "/data/clustering/neuralgas/Complex3.txt",
        "/data/clustering/neuralgas/Complex4.txt",
        "/data/clustering/neuralgas/HiLoDensity.txt"
    };
