...
public class MDSDemo extends JPanel implements Runnable, ActionListener {
    ...
    private static final String[] datasource = {
        "/data/projection/BritishTowns.txt",
        "/data/projection/eurodist.txt",
        "/data/projection/morsecode.txt",
        "/data/projection/colorstimuli.txt",
        "/data/projection/bank05d.txt",
        "/data/projection/bank25d.txt"
    };
